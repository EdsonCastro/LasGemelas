...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="<?php echo base_url('index.php/Bebidas/crear_bebida/')?>" method="POST">
				...
				<div  data-validate = "Por favor, indique si contiene alcohol">¿Contiene alcohol?&nbsp;&nbsp;
					No&nbsp;<input  type="radio" name="alcohol" value="0" checked>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  					Sí&nbsp;<input  type="radio" name="alcohol" value="1">
					<span class="shadow-input1"></span>
				</div>
				...
				<div class="wrap-input1 validate-input" data-validate = "Por favor, rellene el campo Bebida">
					<input class="input1" type="text" name="precio" placeholder="Precio">
					<span class="shadow-input1"></span>
				</div>
