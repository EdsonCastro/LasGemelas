...
<body>
	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="<?php echo base_url('index.php/Materiales/crear_material/')?>" method="POST">
				...
				<div class="wrap-input1 validate-input" data-validate = "Por favor, rellene el campo cantidad">
					<input class="input1" type="text" name="cantidad" placeholder="Cantidad">
					<span class="shadow-input1"></span>
				</div>
