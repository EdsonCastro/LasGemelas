...
<table>
  ...
  <?php
    ...
    <tr>
      ...
      <td data-label="Cantidad"><?php echo($clave[$k]['cantidad']) ?></td>
      <td data-label="Precio"><?php echo(number_format((float)$clave[$k]['precio'], 2, ',', '')." €") ?></td>
      <td data-label="Modificar"><a href="<?php echo base_url('index.php/Materiales/modificar_material/'.$clave[$k]['id'])?>"><span class="glyphicon glyphicon-pencil" style="color:light_blue"></span></a></td>
      <td data-label="Eliminar"><a href="<?php echo base_url('index.php/Materiales/eliminar_material/'.$clave[$k]['id'])?>"><span class="glyphicon glyphicon-remove" style="color:red"></span></a></td>
    </tr>
    <?php }
  ?>
...
<div class="container" align='right'>
    <a href="<?php echo site_url() ?>index.php/Materiales/nuevo_material" class="btn btn-primary" role="button">Añadir</a>
